              ...
              <form className='w-full'>
                <div className='mx-auto w-[75%]'>
                  <div className='bg-gray-100 p-2 flex items-center'>
                    <HiOutlineUser className='text-gray-400 m-2 h-6 w-6' />
                    <input type="text" name="name" id="name" placeholder='Name' className='bg-gray-100 outline-none text-sm font-medium flex-1' />
                  </div>
                  <p className='font-normal text-xs m-0  mb-3 text-left text-red-600'>Error</p>
                  <div className='bg-gray-100 p-2 flex items-center'>
                    <FiMail className='text-gray-400 m-2 h-6 w-6' />
                    <input type="email" name="email" id="email" placeholder='Email' className='bg-gray-100 outline-none text-sm font-medium flex-1' />
                  </div>
                  <p className='font-normal text-xs m-0  mb-3 text-left text-red-600'>Error</p>
                  <div className='bg-gray-100 p-2 flex items-center'>
                    <BiLock className='text-gray-400 m-2 h-6 w-6' />
                    <input type="password" name="password" id="password" placeholder='Password' className='bg-gray-100 outline-none text-sm font-medium flex-1' />
                  </div>
                  <p className='font-normal text-xs m-0 mb-5 text-left text-red-600'>Error</p>
